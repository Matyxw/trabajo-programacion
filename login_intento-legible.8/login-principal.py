...
#-- titulo --#
label_titulo=tk.Label(frame_NorOeste,text="Inicio de sesion",font=("Times",29),bg="#fafafa",fg="#666a88")#0B4EBD antes
...
entry1=tk.Entry(frame_SurEste,width=80,font=("Times",14),fg="#111",bd=1,relief=tk.SOLID,
                highlightbackground="#f00",highlightcolor="#f00")#sinceramente no entiendo porque no se cambia el color del borde fijense si a usds si se lo cambia saquen esas dos propiedades nada mas
