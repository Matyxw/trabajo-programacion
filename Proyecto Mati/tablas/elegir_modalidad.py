...
def pantalla_principal():
    ...
    boton_basico=tk.Button(frame_botones,text="Basico",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,r"Proyecto Mati\tablas\tabla_basico.py"))
    boton_basico.place(relx=0.07,rely=0.20)

    #-- creamos el boton de MMO --#
    boton_MMO=tk.Button(frame_botones,text="MMO",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,r"Proyecto Mati\tablas/tabla_MMO.py"))
    boton_MMO.place(relx=0.39,rely=0.20)

    #-- creamos el boton de informatica --#
    boton_informatica=tk.Button(frame_botones,text="Informatica",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,r"Proyecto Mati\tablas/tabla_informatica.py"))
    boton_informatica.place(relx=0.07,rely=0.46)

    #-- creamos el boton de programacion --#
    boton_programacion=tk.Button(frame_botones,text="Programacion",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,r"Proyecto Mati\tablas/tabla_programacion.py"))
    boton_programacion.place(relx=0.39,rely=0.46)

    #-- creamos el boton de egresados --#
    boton_egresados=tk.Button(frame_botones,text="Egresados",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,r"Proyecto Mati\tablas/tabla_egresados.py"))
    boton_egresados.place(relx=0.07,rely=0.72)

    #-- creamos el boton de estudiantes con pase --#
    boton_e_pases=tk.Button(frame_botones,text="E.Pases",font=("Times",14,"bold"),width=15,height=2,bg="#fff",fg="#111",borderwidth=2,relief="flat",activebackground="#fff",activeforeground="#111", overrelief="solid",command=lambda: abrir_archivo(ventana,r"Proyecto Mati\tablas/tabla_e_pases.py"))
