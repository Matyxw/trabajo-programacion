...
class FormRegisterDesigner:
    ...
    def __init__(self):
        ...
        #frame logo
        frame_logo=tk.Frame(self.ventana, bd=0, width=200, relief=tk.SOLID, padx=10, pady=10,bg='#0871DA')
        frame_logo.pack(side='left',expand=tk.NO,fill=tk.BOTH)
        label=tk.Label(frame_logo,image=logo, bg='#0871DA')
        ...
        register=tk.Button(frame_form_fill, text="Registrar",font=(
            'Times',15),bg="#0871DA",bd=0,fg="#fcfcfc", command=self.register)
